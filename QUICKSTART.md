...
4. Tell the AI:
   ```
   Run: bash <(curl -fsSL https://raw.githubusercontent.com/munsanco13/agent-os/v2.1.0/scripts/autonomous-install.sh)
...
```
AGENT_OS_REF=v2.1.0 bash <(curl -fsSL https://raw.githubusercontent.com/munsanco13/agent-os/v2.1.0/scripts/install.sh)
```
